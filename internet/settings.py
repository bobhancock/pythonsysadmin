...
BASE_DIR = "/home/rhancock/pythoncode/src/sysadmins"
PACKAGE_PATH=os.path.join(BASE_DIR, "pypackages")
# File IO
MAX_FILES = 100
...
# the Go programs.
BIG_FILE = os.path.join(BASE_DIR, "xferlog/bigsmallfile.xferlog") #2 matches
